...
public class LegacyAppComponent: ComponentResource
{
    public Output<string> Endpoint { get; }
    public Output<string> VNetId { get; }
    
    public LegacyAppComponent(string type, LegacyAppComponentArgs args, string name, ComponentResourceOptions? options = null) 
        : base("custom:components:PrivateAppComponent", name, options)
    {
